class Battle_Mouth extends Phaser.Scene{
    
    constructor(){
        super({ key: 'Battle_Mouth' });
    }
    ...
    preload(){
        ...
        this.load.image('t1', 'Battle/Hell1.png');
        ...
        this.load.spritesheet('enemy_mt','enemigos/mouth/mouth_idle.png',
        {
            frameWidth: 560,
            frameHeight: 560
        });

        this.load.spritesheet('enemy_at_mt','enemigos/mouth/mouth_at.png',
        {
            frameWidth: 560,
            frameHeight: 560
        });

        this.load.spritesheet('enemy_dead_mt','enemigos/mouth/mouth_dead.png',
        {
            frameWidth: 560,
            frameHeight: 560
        });
    ...
    create(){
        ...
        this.enemy = this.physics.add.sprite(1450, 640, 'enemy_mt').setScale(1.5);
        this.enemy.body.setCollideWorldBounds(false);

        this.enemy.body.setSize(100, 200, true);
        this.enemy.body.setOffset(300, 300);
        ...
        this.anims.create({
            ...
            // NOTA: generateFrameNames() se
            // usa cuando ya existe un Atlas
            frames: this.anims.generateFrameNumbers('enemy_mt', {
                start: 0,
                end: 15
            }),
        ...
        this.anims.create({
            ...
            // NOTA: generateFrameNames() se
            // usa cuando ya existe un Atlas
            frames: this.anims.generateFrameNumbers('enemy_at_mt', {
                start: 0,
                end: 19
            }),
        ...
        this.anims.create({
            ...
            // NOTA: generateFrameNames() se
            // usa cuando ya existe un Atlas
            frames: this.anims.generateFrameNumbers('enemy_dead_mt', {
                start: 0,
                end: 15
            }),
        ...
        this.enemy.anims.play('enemy_idle_mt');
        ...
        this.btn1.on('pointerdown',()=>{
            ...
            setTimeout(() => {
                if (this.vidaEnemy < 0) {
                    this.enemy.anims.play('enemy_dead_mt');
                    ...
                    if (this.opc % 2 == 0) {
                        this.enemy.anims.play('enemy_attack_mt');
                        setTimeout(() => {
                            this.enemy.anims.play('enemy_idle_mt');
