...
class Battle extends Phaser.Scene{
    ...
    create(){
        ...
        this.btn1 = this.add.image(500, this.height/8, 'Button').setScale(0.2, 0.1).setInteractive();
        this.btn2 = this.add.image(1420, this.height/8, 'Button').setScale(0.2, 0.1).setInteractive();
        this.btn3 = this.add.image(500, this.height/3.5, 'Button').setScale(0.2, 0.1).setInteractive();
        this.btn4 = this.add.image(1420, this.height/3.5, 'Button').setScale(0.2, 0.1).setInteractive();

        this.txt1 = this.add.text(440, 110, "Golpe", {fontFamily: 'IM Fell English SC', fontSize: '45px', color: 'black'});
        this.txt2 = this.add.text(1375, 110, "Tiro", {fontFamily: 'IM Fell English SC', fontSize: '45px', color: 'black'});
        this.txt3 = this.add.text(435, 285, "Pocion", {fontFamily: 'IM Fell English SC', fontSize: '45px', color: 'black'});
        this.txt4 = this.add.text(1335, 285, "Cubrirse", {fontFamily: 'IM Fell English SC', fontSize: '45px', color: 'black'});

        this.txtTurn = this.add.text(this.width/2 - 95, 400, "Tu Turno", {fontFamily: 'IM Fell English SC', fontSize: '45px', color: 'black'});
        this.txtWin = this.add.text(this.width/2 - 80, 400, "Ganaste", {fontFamily: 'IM Fell English SC', fontSize: '45px', color: 'black'});
        this.txtLose = this.add.text(this.width/2 - 80, 400, "Perdiste", {fontFamily: 'IM Fell English SC', fontSize: '45px', color: 'black'});
