class Battle_Mago extends Phaser.Scene{
    
    constructor(){
        super({ key: 'Battle_Mago' });
    }
    ...
    preload(){
        ...
        this.load.image('hell1', 'Battle/Hell1.png');
        ...
        this.load.spritesheet('enemy_m','enemigos/mago/mago_idle.png',
        {
            frameWidth: 300,
            frameHeight: 300
        });

        this.load.spritesheet('enemy_at_m','enemigos/mago/mago_at.png',
        {
            frameWidth: 300,
            frameHeight: 300
        });

        this.load.spritesheet('enemy_dead_m','enemigos/mago/mago_dead.png',
        {
            frameWidth: 300,
            frameHeight: 300
        });
    ...
    create(){
        ...
        this.battle = this.add.image(this.width/2, this.height/2, 'hell1');
        ...
        this.enemy = this.physics.add.sprite(1450, 670, 'enemy_m').setScale(3);
        ...
        this.health_enemy = this.physics.add.sprite(1380, this.enemy.y - 110   , 'health').setScale(.2);
        this.health_enemy2 = this.physics.add.sprite(1500, this.enemy.y - 120, 'health').setScale(.2);
        this.health_enemy3 = this.physics.add.sprite(1440, this.enemy.y - 50, 'health').setScale(.2);
        ...
        this.anims.create({
            ...
            // NOTA: generateFrameNames() se
            // usa cuando ya existe un Atlas
            frames: this.anims.generateFrameNumbers('enemy_m', {
                start: 0,
                end: 20
            }),
        ...
        this.anims.create({
            ...
            // NOTA: generateFrameNames() se
            // usa cuando ya existe un Atlas
            frames: this.anims.generateFrameNumbers('enemy_at_m', {
                start: 0,
                end: 41
            }),
        ...
        this.anims.create({
            ...
            // NOTA: generateFrameNames() se
            // usa cuando ya existe un Atlas
            frames: this.anims.generateFrameNumbers('enemy_dead_m', {
                start: 0,
                end: 32
            }),
        ...
        this.enemy.anims.play('enemy_idle_m');
        ...
        this.btn1.on('pointerdown',()=>{
            ...
            setTimeout(() => {
                if (this.vidaEnemy < 0) {
                    this.enemy.anims.play('enemy_dead_m');
                    ...
                    if (this.opc % 2 == 0) {
                        this.enemy.anims.play('enemy_attack_m');
                        setTimeout(() => {
                            this.enemy.anims.play('enemy_idle_m');
